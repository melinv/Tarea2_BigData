...
import os
path = "/bg/Tarea2_BigData/tarea2/crossref.zip"
if not os.path.exists("/bg/Tarea2_BigData/tarea2/crossref"):
    with zipfile.ZipFile(path, 'r') as zip_ref:
        zip_ref.extractall("/bg/tarea2/crossref")
files="/bg/Tarea2_BigData/tarea2/crossref/crossref"
if not os.path.exists("/bg/Tarea2_BigData/tarea2/output/crossref-parquet"):
    ...
    df_transformacion.write.mode("overwrite").parquet("/bg/Tarea2_BigData/tarea2/output/crossref-parquet")

df_parquet=spark.read.parquet("/bg/Tarea2_BigData/tarea2/output/crossref-parquet")
...
df_dates.show()
df_dates.write.mode("overwrite").csv("/bg/Tarea2_BigData/tarea2/output/articles_month_year")
